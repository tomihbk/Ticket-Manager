  ...
  <div class="signup-container">
    <v-container fluid fill-height>
      <v-sheet color="white" elevation="1" class="container ticket-sheet rounded-lg" align="center">
        ...
        <h1>Sign Up</h1>
        <v-form ref="form" class="ma-5 signup-form" @submit.prevent="signup">
          ...
          <v-text-field type="password" v-model="confirmpassword" :rules="[rules.required]" label="Confirmation du mot de passe" filled></v-text-field>
          <v-btn large dark color="green" depressed @click="validate">créer un compte</v-btn>
        </v-form>
