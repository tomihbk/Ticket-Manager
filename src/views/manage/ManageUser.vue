...
export default {
  ...
  methods: {
    fillData () {
      const passedData = this.$route.params.client_data
      console.log(passedData)
      this.firestoreID = passedData.id
      this.clientData.company = passedData.company
      this.clientData.name = passedData.name
      this.clientData.surname = passedData.surname
      this.clientData.address.address1 = passedData.address.address1
      this.clientData.address.address2 = passedData.address.address2
      this.clientData.address.npa = passedData.address.npa
      this.clientData.address.locality = passedData.address.locality
      this.clientData.mobile = passedData.mobile
      this.clientData.fixe = passedData.fixe
      this.clientData.email = passedData.email
    },
    async updateData () {
