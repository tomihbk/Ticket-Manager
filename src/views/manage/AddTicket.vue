    ...
    <v-container fluid fill-height>
      <v-sheet color="white" elevation="1" class="container ticket-sheet rounded-lg" align="center">
        ...
        <v-form ref="form" class="mt-5 mx-5 signup-form" @submit.prevent="validate">
          <v-row>
            <v-col cols="12" md="12">
              <ais-instant-search :search-client="searchClient" index-name="dev_CLIENTS">
            ...
            <v-col cols="12" md="12">
              <v-file-input accept="image/*" label="Importer une image" @change="previewFiles" multiple dense></v-file-input>
            </v-col>
          </v-row>
      ...
      if (!this.ticketData.title || !this.ticketData.type || !this.ticketData.description || this.signaturePadError || !this.ticketData.user) {
        ...
        try {
          ...
          await statsRef.update({
            ...
            'total-tickets': firebase.firestore.FieldValue.increment(1)
          })
