  ...
  <div class="archive">
    <v-container class="my-5">
      <v-data-table :headers="headers" :items="tickets" :loading="loadingData" :search="search" sort-by="priority" :sortDesc="true" :footer-props="footerProps" @dblclick:row="editItem" class="elevation-1">
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title class="font-weight-bold text-h5">Liste de tickets archivés</v-toolbar-title>
            <v-spacer></v-spacer>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async deleteItemConfirm () {
      const deletedTicket:any = this.tickets[this.editedIndex as number]
